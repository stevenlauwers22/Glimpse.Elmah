...
Glimpse for Elmah
*****************
Thanks for using Glimpse for Elmah.

Project Homepage
----------------
https://github.com/stevenlauwers22/Glimpse.Elmah/

Using it
--------
To use Glimpse for Elmah, all you need to do is:
1. Install the package through NuGet
2. Configure Glimpse if you haven't done it yet
3. Configure Elmah if you haven't done it yet
...
-------------
10/29/2012 - 1.0.0.0
- Updated to version 1.0.0-ctp1 of Glimpse
